...
@Component({
  selector: "y-picture-content",
  templateUrl: "./picture-Content.component.html",
  styleUrl: "./picture-Content.component.scss"
})
export class PictureContentComponent implements AfterViewInit {
  @Input() public hideUserInfo: boolean = false;
  @ViewChild("pictureContent") pictureContent!: ElementRef<HTMLImageElement>;
  ...
  ngAfterViewInit() {
    ...
    // const color = fac.getColor(this.pictureContent.nativeElement);
    // this.isTextDark = color.isDark;
    // console.log(this.isTextDark);
  }
